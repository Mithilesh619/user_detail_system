               ...
               <div class="col-sm-6">
                  ...
                  <form method="post" action="sign_up_action.php">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" name="email" onchange="check_email(this.value)" id="f_2" class="form-control" placeholder="Enter email" required>
                     </div>
                     <div class="form-group">
                        <label>Password<span class="text-danger">*</span></label>
                        <input type="password" class="tel form-control" name="password" id="password"  placeholder="Enter password" required>
                     </div>
                     <div class="form-group">
